			...
			$(".nws-brand .item").click(function(){
				...
				$.ajax({
					...
					success : function(data, status){
						...
						$(".nws-service .title-service").css("display", "none");
						$(".nws-service .title-error").css("display", "none");

						$(".nws-service .nws-model").html(data);
						$(".nws-service .title-model").css("display", "inline-block");
					}
				});
			});
			...
			$(document).on('click', '.nws-model .item', function() {
				...
				$.ajax({
					...
					success : function(data, status){
						...
						$(".nws-service .title-error").css("display", "inline-block");
			...
			$(document).on('click', '.nws-model-error .item', function() {
				...
				$.ajax({
					...
					success : function(data, status){
						...
						$(".nws-service .title-service").css("display", "inline-block");
					}
				});
			});
