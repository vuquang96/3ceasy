...
if (!function_exists('_action_wplab_recover_shortcode_column_enqueue_dynamic_css')):

	/**
	 * @internal
	 * @param array $data
	 */
	function _action_wplab_recover_shortcode_column_enqueue_dynamic_css( $data ) {
    $shortcode = 'column';
	...
	add_action(
	  ...
	  '_action_wplab_recover_shortcode_column_enqueue_dynamic_css'
	);
