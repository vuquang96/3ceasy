		...
		<div class="element">
			<?php
				...
				if( wplab_recover_utils::is_unyson() ) {
					$img_width = absint( fw_get_db_settings_option( 'portfolio_3cols_nospace_thumb_width' ) );
					$img_height = absint( fw_get_db_settings_option( 'portfolio_3cols_nospace_thumb_height' ) );
				}
